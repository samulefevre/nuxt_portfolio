...
const groups = [
  ...
  { name: 'Cloud & delivery', tools: 'NuxtHub · Cloudflare Workers · Docker · CI/CD' },
  { name: 'Mobile', tools: 'Flutter · Dart' },
]
</script>
...
<template>
  ...
  >
    ...
    <dl class="portfolio-stack-list">
      <div
        v-for="group in groups"
        :key="group.name"
      >
        <dt>{{ group.name }}</dt><dd>{{ group.tools }}</dd>
      </div>
    </dl>
  </UPageSection>
</template>
