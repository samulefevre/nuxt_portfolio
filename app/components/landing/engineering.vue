...
const featureUi = {
  root: 'grid grid-cols-[3.1rem_1fr] gap-4 border-b border-default py-[1.7rem]',
  leading: 'p-0 text-[1.4rem] leading-none text-primary',
  title: 'mb-[.55rem] text-[1.22rem]',
  description: 'max-w-[430px] text-[.84rem]',
}
